        ...
        child: Column(
          ...
          children: [
            ...
            _buildContactCard(
              ...
              onTap: () =>
                  _launchWebsite('https://www.facebook.com/SafeRoadTunisie'),
            ),
            const SizedBox(height: 24),
            ...
            const SizedBox(height: 12),
            _buildEmergencyCard(context, isDark, '197', 'Police Nationale'),
            const SizedBox(height: 8),
            _buildEmergencyCard(context, isDark, '198', 'Protection Civile'),
            const SizedBox(height: 8),
            _buildEmergencyCard(context, isDark, '190', 'Urgences SAMU'),
